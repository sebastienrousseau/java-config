...
This document describes how @sebastienrousseau/java-config is run: who decides what, how
...
@sebastienrousseau/java-config is **maintainer-led**. As of the current release line it has a single
