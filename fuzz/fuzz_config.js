...
/**
 * Fuzz testing harness for @sebastienrousseau/java-config
...
function generateFuzzPayload(depth = 0) {
  ...
  switch (type) {
    ...
    case "null":
      return null;
    case "array":
      return [generateFuzzPayload(depth + 1), generateFuzzPayload(depth + 1)];
    case "object":
      return {
        [Math.random().toString(36).substring(7)]: generateFuzzPayload(
          depth + 1,
        ),
      };
  }
