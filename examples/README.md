# `@sebastienrousseau/java-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/java-config`.
...
- [x] **checkstyle.xml**: Standardized rule preset
- [x] **spotbugs-exclude.xml**: Standardized rule preset
- [x] **pmd-ruleset.xml**: Standardized rule preset
